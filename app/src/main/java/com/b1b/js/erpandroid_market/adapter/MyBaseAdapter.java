...
public abstract class MyBaseAdapter<T> extends BaseAdapter {
    ...
    protected abstract void initItems(View convertView, MyBasedHolder holder);

    protected abstract void onBindHolder(T currentData, MyBasedHolder mHolder);
